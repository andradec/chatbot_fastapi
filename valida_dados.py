...
def validar_dados():
    ...
    # 1️⃣ Verificar existência dos arquivos
    ...
    # 3️⃣ Valores ausentes: remover ou preencher
    ...
    # 5️⃣ Integridade: remover vendas com produto ou vendedor inexistente
    ...
    # 8️⃣ Salvar arquivos limpos (opcional)
